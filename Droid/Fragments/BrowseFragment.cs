...
namespace SpectrumApp.Droid
{
    public class BrowseFragment : Android.Support.V4.App.Fragment, IFragmentVisible
    {
        ...
        {
            var item = ViewModel.UserList[e.Position];
    ...
    class BrowseItemsAdapter : BaseRecycleViewAdapter
    {
        ...
        public BrowseItemsAdapter(Activity activity, UsersViewModel viewModel)
        {
            ...
            this.viewModel.UserList.CollectionChanged += (sender, args) =>
            {
        ...
        {
            var item = viewModel.UserList[position];

            // Replace the contents of the view with that element
            var myHolder = holder as MyViewHolder;
            myHolder.TextView.Text = item.Username;
        }

        public override int ItemCount => viewModel.UserList.Count;
    }
